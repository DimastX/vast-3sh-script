...
MODEL_SPECS=(
    ...
    "https://huggingface.co/JunkyByte/easy_ViTPose/resolve/main/onnx/wholebody/vitpose-h-wholebody.onnx|models/detection|vitpose_h_wholebody_model.onnx"
    "https://huggingface.co/hr16/yolox-onnx/resolve/main/yolox_l.onnx|models/detection|yolox_l.onnx"
    "https://huggingface.co/hr16/DWPose-TorchScript-BatchSize5/resolve/main/dw-ll_ucoco_384_bs5.torchscript.pt|models/detection|dw-ll_ucoco_384_bs5.torchscript.pt"
